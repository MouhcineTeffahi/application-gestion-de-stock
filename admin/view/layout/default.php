...
<script src="<?php echo SOURCE_CONTEXT ?>/js/simpleCart.min.js"> </script>
<script src="<?php echo SOURCE_CONTEXT ?>/js/jquery.min.js"></script>
<!-- Custom Theme files -->
<link href="<?php echo SOURCE_CONTEXT ?>/css/style.css" rel='stylesheet' type='text/css' />
<!-- Custom Theme files -->
<!--webfont-->
<link href='http://fonts.googleapis.com/css?family=Raleway:100,200,300,400,500,600,700,800,900' rel='stylesheet' type='text/css'>
<link href='http://fonts.googleapis.com/css?family=Audiowide' rel='stylesheet' type='text/css'>
<script src="<?php echo SOURCE_CONTEXT ?>/js/jquery.easydropdown.js"></script>
<!-- Add fancyBox main JS and CSS files -->
<script src="<?php echo SOURCE_CONTEXT ?>/js/jquery.magnific-popup.js" type="text/javascript"></script>
<link href="<?php echo SOURCE_CONTEXT ?>/css/magnific-popup.css" rel="stylesheet" type="text/css">
		<script>
